...
public class MessagesRepositoryImpl implements MessagesRepository {
    ...
    public Optional<Message> findById(Long id) {
        try {
            ...
            Message message = template.queryForObject(
                    sql, new MessageRowMapper(usersRepository), id);
    ...
    public List<Message> findAll() {
        ...
        return template.query(sql, new MessageRowMapper(usersRepository));
    }

    @Override
    public void save(Message entity) {
        String sql = "INSERT INTO messages " +
                "(identifier, sender, text, date_time) VALUES (?, ?, ?, ?)";
        template.update(sql,
    ...
    public void update(Message entity) {
        String sql = "UPDATE messages " +
                "SET identifier = ?, sender = ?, text = ?, date_time = ? " +
                "WHERE identifier = ?;";
        Long id = entity.getIdentifier();
        template.update(sql, id, entity.getSender().getIdentifier(),
                entity.getText(), Timestamp.valueOf(entity.getDateTime()));
    }
    ...
    public List<Message> findAllOfSenderId(Long id) {
        ...
        return template.query(sql, new MessageRowMapper(usersRepository), id);
    }
}
